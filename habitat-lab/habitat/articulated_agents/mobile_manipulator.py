...
class MobileManipulatorParams:
    ...
    :property base_rot_offset: The rotation of the root transform from the center ground point for navmesh kinematic control.
    ...
    base_rot_offset: mn.Quaternion = mn.Quaternion.identity_init()
